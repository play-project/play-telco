...
/**
 * <p>
 * This class defines OutOfNetworkEvent event.
 * </p>
 * <p>
 * for input  event
 * <p>
 ...
 * </p>
 * 
 * PLAY project - OutOfNetwork Event from Siafu simulator - simulating  cellular Event
 * 
 * @author Philippe Gibert BIZZ/DIAM/EMB
 */

public class OutNetworkEvent extends inEvent {


	protected Boolean outOfNetwork;
	...
	public OutNetworkEvent() {
	}


	public OutNetworkEvent(String timeStamp, String uniqueId, String sequenceNumber) {
		super(timeStamp, uniqueId, sequenceNumber);
		// TODO Auto-generated constructor stub
	}

	public OutNetworkEvent(String timeStamp, String uniqueId, String sequenceNumber, 
			Boolean outOfNetwork, String signalStrength, String callerPhoneNumber,String calleePhoneNumber,
	...
	public String toStringCEP1() {
		return "stream=OutOfNetworkEvent,uniqueId=" + uniqueId + ",sequenceNumber="
		+ sequenceNumber + ",timeStamp=" + timeStamp + ",outOfNetwork="
		+ outOfNetwork + ",signalStrength=" + signalStrength + ",callerPhoneNumber="
		+ callerPhoneNumber  + ",calleePhoneNumber="
		+ calleePhoneNumber + ",latitude=" + latitude + ",longitude=" + longitude ; 
	}

	public String toRDF(String AppID) {
		String pattern05 = AppID;
		String pattern07 = "TaxiUCOutNetwork";
		String pattern09 = "http://streams.event-processing.org/ids/TaxiUCOutNetwork#stream" ;
		...
		String str1 = 
			...
			"uctelco:uniqueId \"#6#\" ;\n"+
			"uctelco:outOfNetwork \"#10#\" ;\n"+
			"uctelco:signalStrength \"#11#\" ;\n"+
		...
		avaTemplate = avaTemplate.replaceFirst("#10#", Boolean.toString(this.outOfNetwork));
		avaTemplate = avaTemplate.replaceFirst("#11#", this.signalStrength);
		System.out.println("this.calleePhoneNumber" + this.calleePhoneNumber);
		System.out.println("this.callerPhoneNumber" + this.callerPhoneNumber);
	...
	public String toString() {
		return "OutOfNetworkEvent [uniqueId=" + uniqueId + ", sequenceNumber="
		+ sequenceNumber + ", timeStamp=" + timeStamp + ", outOfNetwork="
		+ outOfNetwork + ", signalStrength=" + signalStrength + ", callerPhoneNumber="
		+ callerPhoneNumber + ", calleePhoneNumber="
	...
	public String toXML() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <OutOfNetworkEvent xmlns=\"http://www.orange.org/TaxiEventType\" "+
		"xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
		"xsi:schemaLocation=\"http://www.orange.org/TaxiEventType TaxiEventType.xsd\">"+
		"<uniqueId>"+uniqueId+"</uniqueId>"+
		"<sequenceNumber>"+sequenceNumber+"</sequenceNumber>"+
		"<timeStamp>"+timeStamp+"</timeStamp>"+
		"<outOfNetwork>"+outOfNetwork+"</outOfNetwork>"+
	...
	public String toWSN() {
		return "<OrangeLabsTaxiUC:OutOfNetworkEvent xmlns=\"http://www.orangelabs.org/DefTaxiEventType\" "+
		"xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
		...
		"<latitude>"+latitude+"</latitude>"+
		"<longitude>"+longitude+"</longitude>"+
		"</OrangeLabsTaxiUC:OutOfNetworkEvent>";
	}
	//	
	//	public String toString() {
	//		return "OutOfNetworkEvent [outOfNetwork=" + outOfNetwork + ", outOfNetwork=" + outOfNetwork
