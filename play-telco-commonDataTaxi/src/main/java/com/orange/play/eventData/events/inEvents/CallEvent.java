...
/**
 * <p>
 * This class defines CallEvent event.
 * </p>
 * <p>
 * for input  event
 * <p>
...
public class CallEvent extends inEvent {
	...
	public String toStringCEP1() {
		return "stream=CallEvent,uniqueId=" + uniqueId + ",sequenceNumber="
	...
	public String toString() {
		return "CallEvent [uniqueId=" + uniqueId + ", sequenceNumber="
				+ sequenceNumber + ", timeStamp=" + timeStamp + ", direction="
				+ direction + ", message=" + message + ", callerPhoneNumber="
				+ callerPhoneNumber + ", calleePhoneNumber="
	...
	public String toWSN() {
		return "<OrangeLabsTaxiUC:CallEvent xmlns=\"http://www.orangelabs.org/DefTaxiEventType\" "+
		"xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
