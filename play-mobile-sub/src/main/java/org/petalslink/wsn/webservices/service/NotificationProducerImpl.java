...
public class NotificationProducerImpl implements INotificationProducer {
    ...
    public GetCurrentMessageResponse getCurrentMessage(GetCurrentMessage getCurrentMessage)
        ...
        System.out.println("getCurrentMessage, please implement me at org.petalslink.wsn.webservices.service.NotificationProducerImpl!");

        Message message = RefinedWsnbFactory.getInstance().createNotificationMessageHolderTypeMessage(null);
    ...
    public SubscribeResponse subscribe(Subscribe subscribe) throws WsnbException, AbsWSStarFault {
        System.out.println("Orange labs Implementation to test");
        ...
        // create a subscribe response, pushing a registration ID will be nice...
       ...
       // address.setValue(URI.create("http://localhost:99998/foo/bar"));
        address.setValue(URI.create("http://s-m2mc2.rd.francetelecom.fr:7080/wsnservices/services/NotificationConsumerService"));
        registrationRef.setAddress(address);
        System.out.println("registrationRef.setAddress(address): " + "http://s-m2mc2.rd.francetelecom.fr:7080/wsnservices/services/NotificationConsumerService");
